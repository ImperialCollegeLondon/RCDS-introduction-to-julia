...
begin
	...
	lines!(ax2, num_pirates, global_temp, label="line")
	scatter!(ax2, num_pirates, global_temp, label="points")
	fig2
end
...
begin
	...
	ax6b = Axis(fig6[2,1]); lines!(ax6b, z, z.^2)
	ax6c = Axis(fig6[3,1]); lines!(ax6c, z, z.^3)
	ax6d = Axis(fig6[4,1]); lines!(ax6d, z, z.^4)
	fig6
end
